package com.easyPoi.test.excel;

import cn.afterturn.easypoi.excel.ExcelExportUtil;
import cn.afterturn.easypoi.excel.entity.ExportParams;
import cn.afterturn.easypoi.excel.entity.TemplateExportParams;
import cn.afterturn.easypoi.excel.entity.params.ExcelExportEntity;
import com.fast.EasyPoiApplication;
import com.fast.easyPoi.vo.HandsomeBoyPOJO;
import com.fast.easyPoi.vo.ResultPOJO;
import com.fast.easyPoi.vo.StudentVO;
...
public class ExcelExportTest {
    ...
    public void directExportExcel() throws IOException {
        ...
        FileOutputStream fos = new FileOutputStream("C:/Users/ASUS/Desktop/abc.xls");
        workbook.write(fos);
        fos.close();
    }
    ...
    public void directExportExcelByObject() throws IOException {
        ...
        FileOutputStream fos = new FileOutputStream("C:/Users/ASUS/Desktop/student.xls");
        workbook.write(fos);
        fos.close();
    }
    ...
    public void templateExportExcelByMap() throws IOException {
        ...
        FileOutputStream fos = new FileOutputStream("C:/Users/ASUS/Desktop/templateMapResult.xls");
        workbook.write(fos);
        fos.close();
    }
    ...
    public void templateExportExcelByObject() throws IOException, IllegalAccessException {
        ...
        FileOutputStream fos = new FileOutputStream("C:/Users/ASUS/Desktop/templateObjectResult.xlsx");
        workbook.write(fos);
        fos.close();
    }
