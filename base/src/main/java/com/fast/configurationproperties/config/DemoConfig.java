package com.fast.configurationproperties.config;


import com.fast.configurationproperties.model.User;
import lombok.Data;
...
public class DemoConfig {
     ...
     *
     * @Autowired
     * @Qualifier("initInfoMap") private Map<String, User> initInfoMap;
     * 这样获取就行
     * @date 2019/6/3 14:48
     */
